...
import { messengerABI } from "./ContactUsABI";
...
const ContactUs = () => {
	...
	const [disablePrivateMsg, setDisablePrivateMsg] = useState(true);
  ...
  const [publicKeyLoading, setPublicKeyLoading] = useState({
    button: false,
    metakeyAprove: false,
    setKeyAprove: false,
    confirming: false,
  ...
  const encryptFunc = (msg, publicEncryptionKey) => {
    const encryptedMsgPlain = encrypt(
      publicEncryptionKey,
      { data: msg },
  ...
  const getPublicKey = async (address) => {
    ...
    try {
      ...
      const publicKey = await contract.methods
        ...
        .call()
        .then((res) => res);
      console.log("public key", address, publicKey, publicKey.lenght);
      return publicKey;
    } catch (err) {
      console.log(err);
      return false;
    ...
    try {
      ...
      contract.methods
        .sendMessage(
          to,
          subject,
          JSON.stringify(msgToSend).replaceAll('"', "'")
        )
        .send({ from: account })
        .on("transactionHash", (transactionHash) => {
          setStages({
  ...
  const handleChangeAddress = async (e) => {
    ...
    if (e.target.value.length === 42) {
      ...
      if (publicKey === false || !(publicKey.length > 1))
        setDisablePrivateMsg(true);
      else {
        setReceiverPublicKey(publicKey);
        setDisablePrivateMsg(false);
      }
      console.log("getting public key in input", publicKey);
      console.log("disablePrivateMsg", disablePrivateMsg);
    }
  };
  useEffect(() => {
    (async () => {
  ...
  useEffect(() => {
    ...
    if (location.state && location.state.type === "fromInbox") setShowTo(true);
  ...
  const runFunc = async (address) => {
    ...
    console.log("disablePrivateMsg2", disablePrivateMsg);
  };
  if (!active)
    return (
        ...
        <div className="d-flex flex-column align-items-center position-relative mt-4 w-100 h-100">
          ...
          {!showTo && (
            ...
            >
              ...
              <option value="0xfe6754537CfE0aD4Eb9F3996Ae9c36A717CBaaFb">
                Director
              </option>
              <option value="0x8C97769D2Fc3e18967375B9E6e4214f1A393A862">
                Dapp
              </option>
              <option value="0x2beD17dDE61A5b862409eF7Af301229Ae50387f0">
                Solidity
              </option>
            </select>
          )}
                ...
                overlay={
                  ...
                  >
                    <div style={{ textAlign: "justify" }}>
                      this part doesn't encrypt. It helps you and the receiver
                      read something about the private message. Be careful
                      everybody can read this part.
                    </div>
                  </Tooltip>
                }
              >
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip
                    style={{ border: "3px solid white", background: "black" }}
                  >
                    this part can encrypt and send in private mode. Be careful
                    in the private mode; you can't read your sent message
                    anymore.
                  </Tooltip>
                }
              >
          ...
          <div className="d-flex flex-column">
            <Button
              secondary
              disabled={disablePrivateMsg}
              style={{ width: "20rem" }}
              onClick={() => {
                handleSendMessage("private");
              }}
            >
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip
                    style={{ border: "3px solid white", background: "black" }}
                  >
                    the message will encrypt whit the receiver's Public key, and
            ...
            >
              ...
              >
                {publicKeyLoading.button && (
                  <>
                      ...
                      <h5>
                        ...
                        <OverlayTrigger
                          ...
                          overlay={
                            ...
                            >
                              By clicking this, allow other people to send you
                              messages in private mode. It means anyone can't
                    ...
                    <div
                      ...
                      style={{ top: "25%" }}
                    >
                      <Button secondary onClick={() => reqPublicKey()}>
                        Enable Public Key
                      </Button>
                      <Button
                        onClick={() => {
                      ...
                      >
                        No, Thanks. Just send the message.
                      </Button>
                    </div>
                  </>
                )}
                ...
                {publicKeyLoading.confirming && (
                  ...
                  >
                    <div className="text-center">
                      <h5>wating to confirm public key</h5>
                    </div>
                    <div>
                      <LoadingBalls />
                    </div>
