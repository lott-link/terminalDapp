...
const NFTCrossChain = () => {
    ...
    const firstApprove = ()=>{
        ...
        .then(()=>setApproves({first:true,second:false}))
    }
    const transfer = ()=>{
        ...
        <div className='w-100 h-100' style={{display:'flex',flexFlow:'column'}} >
            ...
            <div className='d-flex' style={{flexGrow:"1"}}>
                <div className='w-50 h-100 p-2' style={{borderRight:"1px solid white",position:"relative"}}>
                    {approves.first && <div style={{width:'100%',height:"100%",background:"white",position:'absolute',top:"0",left:"0",zIndex:'10',opacity:"50%"}}></div>} 
                ...
                <div className='w-50 h-100 p-2' style={{position:'relative'}}>
                    {approves.second&&<div style={{width:'100%',height:"100%",background:"white",position:'absolute',top:"0",left:"0",zIndex:'10',opacity:"50%"}}></div>}
                    <div className='w-100 h-100' style={{border:"1px solid white"}}>
                        <div className='text-center py-4' style={{borderBottom:"1px solid white",fontSize:"22px"}}>
                            Cross Chainin
                        </div>
