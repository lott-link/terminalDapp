...
const contractRoutes = [
    ...
    // {path:'/contract/signin',exact:true,component:ContractPage,title:"Sign_In",type:'link',render:true,display:true},
    {path:'/contract/createchanceroom',exact:true,component:CreateChanceRoom,title:"Chance_Room",type:'link',render:true,display:true},
