...
const toolsRoutes = [
	...
	{
		path: "/tools/AbiInputsGenerator",
		exact: true,
		component: AbiInputsGenerator,
		title: "ABI_Inputs_Generator",
		type: "link",
		render: true,
		display: true,
	},
	{
		path: "/tools/read_owner_of_contract",
		exact: true,
		component: ReadOwnerOfContract,
		title: "Read_Owner_Of_Contract",
		type: "link",
		render: true,
		display: true,
	},
